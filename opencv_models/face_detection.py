...
def detect(gray, frame): 
	faces = face_cascade.detectMultiScale( # Função geral que detecta objetos
        gray, # Escala cinza
        # scaleFactor=1.5, # Para rostos mais proximos a camera
        # janela movel para detectar objetos
        minNeighbors=5, # define quantos objetos são detectados perto do atual antes de declarar a face encontrada
